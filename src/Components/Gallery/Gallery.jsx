      ...
      <section className="bg-sectionBgColor dark:bg-DarkModeSectionBgColor px-4 py-20">
        ...
        {isHomepage && (
          <div className="view-all-foods w-11/12 md:w-9/12 mx-auto text-center mt-10">
            <Link
              to="/gallery"
              className="border border-primaryColor text-primaryColor px-6 py-3 font-bold text-lg font-headingFont transition-bg duration-300 hover:bg-primaryColor hover:text-white"
            >
              View Full Gallery
            </Link>
          </div>
